...
@SpringBootTest(classes = {
        StepExecutionListenerTest.TestConfig.class,
    ...
    static class TestConfig {
        ...
        public Step stepOne() {
            return stepBuilderFactory.get("myFirstStep")
                    .tasklet(this.stepAndListenerInOneComponent)
                    .listener(this.stepAndListenerInOneComponent)
                    .build();
        }
        ...
        public Step stepTwo() {
            return stepBuilderFactory.get("mySecondStep")
                    .tasklet((stepContribution, chunkContext) -> {
                        ExecutionContext executionContext = stepContribution
                                .getStepExecution()
                                .getJobExecution()
                                .getExecutionContext();
