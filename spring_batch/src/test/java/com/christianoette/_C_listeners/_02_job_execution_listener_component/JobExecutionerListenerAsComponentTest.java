...
@SpringBootTest(classes = {JobExecutionerListenerAsComponentTest.TestConfig.class, JobListenerAsComponent.class, JobResultHolder.class})
class JobExecutionerListenerAsComponentTest {
    ...
    static class TestConfig {
        ...
        public Step step(JobResultHolder jobResultHolder) {
            return this.stepBuilderFactory.get("annotationListenerTest")
